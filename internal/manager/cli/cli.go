...
import (
	...
	"github.com/mrlutik/kira2.0/internal/manager/cli/commands/config"
...
func Start() {
	commands := []*cobra.Command{start.Start(), monitoring.Monitoring(), firewall.Firewall(), maintenance.Maintenance(), initnode.Init(), stop.Stop(), config.Config()}
